...
```sh
/tmp/dinov2-final-venv/bin/python scripts/parity_check.py --cli build-debug/bin/dinov2-cli --gguf /tmp/dinov2-final-work/public/regular/model.gguf --hf-model /tmp/dinov2-final-work/hf/dinov2-small-imagenet1k-1-layer --image assets/tench.jpg --cls-threshold 0.999 --pooled-threshold 0.999 --patches-threshold 0.99 --patches-token-min-threshold 0 --prob-tolerance 0.05
```
...
cls                                                                           max|d| 0.110232     info          -
pooled                norm 58.7241                norm 58.7457                cos 0.999928        >= 0.999      PASS
pooled                                                                        max|d| 0.110232     info          -
patches flat          1320x384                    1320x384                    cos 0.999571        >= 0.99       PASS
...
classify prob         0.982613                    0.982652                    |diff| 0.000039     < 0.05        PASS
